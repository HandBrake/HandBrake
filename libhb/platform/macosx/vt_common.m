...
static int hb_vt_is_costant_quality_available(CMVideoCodecType codecType)
{
    if (@available (macOS 10.13, *))
    {
        CFStringRef encoderIDOut;
...
int hb_vt_h264_is_costant_quality_available()
{
    return hb_vt_is_costant_quality_available(kCMVideoCodecType_H264);
}

int hb_vt_h265_is_costant_quality_available()
{
    return hb_vt_is_costant_quality_available(kCMVideoCodecType_HEVC);
}
