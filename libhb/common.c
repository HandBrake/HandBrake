...
enum
{
    ...
    HB_GID_VCODEC_H264,
    HB_GID_VCODEC_H265_8BIT,
    HB_GID_VCODEC_H265_10BIT,
    HB_GID_VCODEC_H265_12BIT,
    HB_GID_VCODEC_H265_16BIT,
    HB_GID_VCODEC_MPEG2,
    HB_GID_VCODEC_MPEG4,
...
hb_encoder_internal_t hb_video_encoders[]  =
{
    ...
    { { "H.265 8 bit (x265)",  "x265",       "H.265 8 bit (libx265)",   HB_VCODEC_X265_8BIT,      HB_MUX_AV_MP4|HB_MUX_AV_MKV,   }, NULL, 1, HB_GID_VCODEC_H265_8BIT,   },
    { { "H.265 10 bit (x265)", "x265_10bit", "H.265 10 bit (libx265)",  HB_VCODEC_X265_10BIT,     HB_MUX_AV_MP4|HB_MUX_AV_MKV,   }, NULL, 1, HB_GID_VCODEC_H265_10BIT,   },
    { { "H.265 12 bit (x265)", "x265_12bit", "H.265 12 bit (libx265)",  HB_VCODEC_X265_12BIT,     HB_MUX_AV_MP4|HB_MUX_AV_MKV,   }, NULL, 1, HB_GID_VCODEC_H265_12BIT,   },
    { { "H.265 16 bit (x265)", "x265_16bit", "H.265 16 bit (libx265)",  HB_VCODEC_X265_16BIT,     HB_MUX_AV_MP4|HB_MUX_AV_MKV,   }, NULL, 1, HB_GID_VCODEC_H265_16BIT,   },
    { { "H.265 (Intel QSV)",   "qsv_h265",   "H.265 (Intel Media SDK)", HB_VCODEC_QSV_H265,     HB_MUX_MASK_MP4|HB_MUX_MASK_MKV, }, NULL, 1, HB_GID_VCODEC_H265_8BIT,   },
