...
{                                                                                               \
    ...
    hb_layout_get_name(&layout, ch_layout_str, sizeof(ch_layout_str));                          \
                                                                                                \
    av_channel_layout_copy(&init->ch_layout, &layout);                                          \
                                                                                                \
    hb_dict_set_string(avsettings, "channel_layouts", ch_layout_str);                           \
