...
namespace HandBrakeWPF.Properties
{
    ...
    public class Resources
    {
        ...
        ///Non-Live Options: {date} {time} {modification-iso-datetime} {creation-date} {creation-time} {modification-date} {modification-time} {quality} {bitrate} (These only change if you scan a new source, change title or chapters).
        /// </summary>
