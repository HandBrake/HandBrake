...
namespace HandBrake.Interop.Interop.HbLib
{
    public class NativeConstants
    {
        ...
        public const uint HB_DECODE_SUPPORT_AMFDEC = 0x20;

        public const uint HB_DECODE_SUPPORT_HWACCEL = (HB_DECODE_SUPPORT_NVDEC | HB_DECODE_SUPPORT_VIDEOTOOLBOX | HB_DECODE_SUPPORT_MF | HB_DECODE_SUPPORT_AMFDEC);
    }
}
