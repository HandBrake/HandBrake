...
namespace HandBrake.Interop.Interop.HbLib
{
    ...
    internal static class HBFunctions
    {
        ...
        public static extern void hb_scan(IntPtr hbHandle, IntPtr path, int title_index, int image_sequence, IntPtr sequence_framerate, int preview_count, int store_previews, ulong min_duration);
