...
{
    GtkButton *play_button = GTK_BUTTON(ghb_builder_widget("live_preview_play"));
...
{
    if (pix == NULL || ud->preview->state == PREVIEW_STATE_LIVE)
    {
        return;
    }
...
/*
 * TODO: Connect to the notify::is-maximized signal.
 */
G_MODULE_EXPORT void
