...
dep_map = (
    ...
    DepEntry("VideoEncoder", "VideoOptionExtraWindow", "x264|x265|x265_10bit|x265_12bit|x265_16bit|mpeg4|mpeg2|VP8", False, True),
    DepEntry("VideoEncoder", "VideoOptionExtraLabel", "x264|x265|x265_10bit|x265_12bit|x265_16bit|mpeg4|mpeg2|VP8", False, True),
