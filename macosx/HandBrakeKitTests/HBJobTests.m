...
- (void)setUp
{
    ...
    [self.core scanURL:sampleURL titleIndex:0 imageSequence:false sequenceFramerate:@"0" previews:1 minDuration:0 keepPreviews:NO progressHandler:^(HBState state, HBProgress progress, NSString * _Nonnull info) {
...
- (void)testAutoCrop
{
    XCTAssertEqual([self.preset[@"PictureAutoCrop"] boolValue], self.job.picture.cropMode);
}
